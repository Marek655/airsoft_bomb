...
void setup(){
  ...
  lcd.print("AIRSOFT BOMBA V1");// you can add your team name or someting cool
  lcd.setCursor(0,1);
  lcd.print("  MAREK LASSO");// you can add your team name or someting cool
